...
const industriesData = [
  {
    icon: <Hospital className="h-12 w-12 text-secondary" />,
    title: "Healthcare",
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            {industriesData.map((industry, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-xl p-8 hover:border-secondary/40 transition-all duration-300"
              >
                <div className="p-3 rounded-full bg-secondary/20 mb-6 inline-block">{industry.icon}</div>
          ...
          >
            <button 
              ...
              className="bg-gradient  text-white px-8 py-3 rounded-full font-medium inline-block"
            >
